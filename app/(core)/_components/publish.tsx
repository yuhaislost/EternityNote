...
const Publish = function({ initialData } : PublishProps)
{
    ...
    const onPublish = function(){
        ...
        toast.promise(promise, {
            ...
            'success': 'Published a Note!',
            'error': 'Failed to publish a note.'
        });
    }

    const onUnpublish = function(){
        setIsSubmitting(true);
        ...
        toast.promise(promise, {
            ...
            'success': 'Unpublished a Note!',
            'error': 'Failed to unpublish a note.'
        });
    }
                    ...
                    <div className="space-y-4">
                        <div className="flex items-center gap-x-2">
                            ...
                            <p className="text-xs font-medium text-sky-500">
                                This note can be accessed by anyone on the web!
                            </p>
                        </div>
