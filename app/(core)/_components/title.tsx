...
const Title = function({ initialData }: TitleProps)
{
    ...
    return(
        <div className="flex items-center gap-x-1">
            ...
            { isEditing ? (
                <Input ref={inputRef} onClick={enableInput} onBlur={disableInput} onChange={onChange} onKeyDown={onKeyDown} value={title} 
