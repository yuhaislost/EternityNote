...
const Toolbar = function({ initialData, preview} : ToolbarProps)
{
    ...
    const onKeyDown = function(event: React.KeyboardEvent<HTMLTextAreaElement>)
    {
        if (event.key === 'Enter')
        {
    ...
    const onIconSelect = function(icon: string)
    {
        update({
            id: initialData._id,
            icon: icon
